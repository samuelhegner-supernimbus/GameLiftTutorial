...
<img src="images/project-screenshot.png" width=100% height=100%>
...
#### Accounts
Additionally, you will need the following things configured. Everything below is described in detail in the Tutorial series found here: >TutorialLink<
...
3. Initialise the Git submodules
   ...
   git submodule init
   ```
4. Pull the BrainCloud Client plugin
   ```sh
   git submodule update
   ```
5. Generate the VisualStudio project files

<img src="images/generate-solution-screenshot.png" width=65% height=65%>


1. Rebuild the Development Editor target in VisualStudio
   
<img src="images/rebuild-editor-screenshot.png" width=65% height=65%>

7. You can now launch the project

## Usage

If you have all of the account prerequisites set up and you just want to hook up your BrainCloud environment make sure you change the following variables in the GameInstance blueprint:
...
## Resources
The following resources helped along the way of putting this project together:
...
GameLift
* https://www.youtube.com/watch?v=tCum8vhJE5g
* https://docs.aws.amazon.com/gamelift/latest/developerguide/fleets-creating-anywhere.html
* https://slproweb.com/products/Win32OpenSSL.html
* https://cmake.org/download/
* https://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift-build-cli-uploading.html#gamelift-build-cli-uploading-install
* https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist?view=msvc-170
* https://docs.aws.amazon.com/systems-manager/latest/userguide/session-manager-working-with-install-plugin.html


BrainCloud
* https://portal.braincloudservers.com/signup#/
* https://github.com/getbraincloud/braincloud-unreal-plugin-src/releases/
* https://github.com/getbraincloud/brainclouds2s-unreal
* https://help.getbraincloud.com/en/articles/5606739-using-braincloud-lobbies-with-your-gamelift-servers
* https://help.getbraincloud.com/en/articles/3272699-design-multiplayer-lobbies
* https://help.getbraincloud.com/en/articles/3808406-custom-multiplayer-server-with-unreal
